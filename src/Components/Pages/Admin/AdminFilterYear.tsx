        ...
        if(!inputData){
            setValidationData(
                <div className="alert alert-danger filter__input" role="alert">
                  Поле заполнения года обязательно для заполнения
                </div>
            )
                ...
                <div className="container-fluid">
                    <div className="row mb-12">
                        <div className="col-sm-12">
                            <h1 className="m-0">Фильтр по году</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section className="content">
                <div className="container-fluid">
                    ...
                    <button
                        onClick={() => {
                            if(validation()){
                                saveData("view-dates/year/" + inputData + "/save-to-word").then(r => {})
                            }
                        }}
                    ...
                    <button
                        onClick={() => {
                            if(validation()){
                                saveData("view-dates/year/" + inputData + "/save-to-pdf").then(r => {})
                            }
                        }}
                    ...
                    <button
                        onClick={() => {
                            if(validation()){
                                saveData("view-dates/year/" + inputData + "/save-to-excel").then(r => {})
                            }
                        }}
                    ...
                    <button
                        onClick={() => {
                            if(validation()){
                                saveData("view-dates/year/" + inputData + "/save-to-html").then(r => {})
                            }
                        }}
                        className={"btn btn-danger margin-left-10"}
                    >
...
export default AdminFilterYear;
